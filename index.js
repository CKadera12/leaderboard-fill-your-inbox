...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[420,191,138,93],[840,285,138,93],[874,95,138,93],[280,191,138,93],[560,96,138,93],[840,190,138,93],[280,96,138,93],[140,96,138,93],[700,285,138,93],[560,191,138,93],[0,286,138,93],[734,95,138,93],[700,190,138,93],[0,96,138,93],[420,96,138,93],[140,191,138,93],[0,191,138,93],[874,0,138,93],[734,0,138,93],[455,286,108,32],[140,286,153,64],[0,0,732,94],[295,286,158,44]]}
];
...
(lib.leaderboardsimplefillinboxsomethingdelicious = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({regX:0,regY:0,scaleX:0.02,scaleY:0.02,x:660.9},0).to({regX:0.1,regY:0.2,scaleX:0.74,scaleY:0.74,x:660.8,alpha:1},6).to({scaleX:0.67,scaleY:0.67},7).wait(198));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(51).to({x:-63.2},0).to({x:114,alpha:1},10).to({x:104},6).wait(158));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(51).to({x:-63.2,y:63.3},0).to({x:113.6,y:63.8,alpha:1},10).to({x:103.6},6).wait(158));
	...
	// party-ready
	this.instance_4 = new lib.partyreadyrecipes();
	this.instance_4.parent = this;
	this.instance_4.setTransform(135,28.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(35).to({x:122.5},0).to({x:346,alpha:1},10).to({x:336},6).wait(57).to({alpha:0},5).wait(112));

	// fill-up-mask (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	var mask_4_graphics_0 = new cjs.Graphics().p("AwhDDIAAkDMAkGAAAIAAEDg");
	var mask_4_graphics_108 = new cjs.Graphics().p("AwhDDIAAkDMAkGAAAIAAEDg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:mask_4_graphics_0,x:125.3,y:19.5}).wait(108).to({graphics:mask_4_graphics_108,x:125.3,y:19.5}).wait(117));

	// fill-your-inbox-with
	this.instance_5 = new lib.fillyourinboxleaderboard();
	this.instance_5.parent = this;
	this.instance_5.setTransform(130.9,28.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(35).to({x:-93.2},0).to({x:131.4,alpha:1},10).to({x:121.4},6).wait(174));

	// something-delicious
	this.instance_6 = new lib.leaderboardsomethingdelicious();
	this.instance_6.parent = this;
	this.instance_6.setTransform(336.1,27);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(188).to({alpha:1},10).wait(27));

	// holiday-inspiration
	this.instance_7 = new lib.leaderboardholidayinspiration();
	this.instance_7.parent = this;
	this.instance_7.setTransform(338.2,27);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(148).to({x:328.2},0).to({alpha:1},10).wait(30).to({alpha:0},5).wait(32));

	// diy-tips
	this.instance_8 = new lib.leaderboarddiytips();
	this.instance_8.parent = this;
	this.instance_8.setTransform(274.7,27);
	this.instance_8.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(108).to({alpha:1},10).wait(30).to({alpha:0},5).wait(72));
	...
	this.instance_10.setTransform(512,48.5);
	this.instance_10.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(88).to({x:515,alpha:1},0).wait(137));

	// cookie-berries
	this.instance_11 = new lib.cookieberries_1();
	this.instance_11.parent = this;
	this.instance_11.setTransform(507.8,48.5);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(85).to({x:515,alpha:1},0).wait(140));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(78).to({x:515,alpha:1},0).wait(147));

	// cookie-eighteen
	this.instance_13 = new lib.cookieeighteen_1();
	this.instance_13.parent = this;
	this.instance_13.setTransform(507.8,48.5);
	this.instance_13.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(71).to({x:515,alpha:1},0).wait(154));

	// cookie-seventeen
	this.instance_14 = new lib.cookieseventeen_1();
	this.instance_14.parent = this;
	this.instance_14.setTransform(511,48.5);
	this.instance_14.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(67).to({x:515,alpha:1},0).wait(158));

	// cookie-sixteen
	this.instance_15 = new lib.cookiesixteen_1();
	this.instance_15.parent = this;
	this.instance_15.setTransform(507.8,48.5);
	this.instance_15.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(63).to({x:515,alpha:1},0).wait(162));

	// cookie-fifteen
	this.instance_16 = new lib.cookiefifteen_1();
	this.instance_16.parent = this;
	this.instance_16.setTransform(511,48.5);
	this.instance_16.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(59).to({x:515,alpha:1},0).wait(166));

	// cookie-twelve
	this.instance_17 = new lib.cookietwelve_1();
	this.instance_17.parent = this;
	this.instance_17.setTransform(507.8,48.5);
	this.instance_17.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(55).to({x:515,alpha:1},0).wait(170));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(51).to({x:515,alpha:1},0).wait(174));

	// cookie-ten
	this.instance_19 = new lib.cookieten_1();
	this.instance_19.parent = this;
	this.instance_19.setTransform(511,48.5);
	this.instance_19.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(47).to({x:515,alpha:1},0).wait(178));

	// cookie-nine
	this.instance_20 = new lib.cookienine_1();
	this.instance_20.parent = this;
	this.instance_20.setTransform(507.8,48.5);
	this.instance_20.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(43).to({x:515,alpha:1},0).wait(182));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(39).to({x:515,alpha:1},0).wait(186));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(35).to({x:515,alpha:1},0).wait(190));

	// cookie-six
	this.instance_23 = new lib.cookiesix_1();
	this.instance_23.parent = this;
	this.instance_23.setTransform(515,48.5);
	this.instance_23.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(31).to({alpha:1},0).wait(194));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(27).to({alpha:1},0).wait(198));

	// cookie-four
	this.instance_25 = new lib.cookiefour_1();
	this.instance_25.parent = this;
	this.instance_25.setTransform(507.8,48.5);
	this.instance_25.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(23).to({x:515,alpha:1},0).wait(202));

	// cookie-three
	this.instance_26 = new lib.cookiethree_1();
	this.instance_26.parent = this;
	this.instance_26.setTransform(511,48.5);
	this.instance_26.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(19).to({x:515,alpha:1},0).wait(206));

	// cookie-two
	this.instance_27 = new lib.cookietwo_1();
	this.instance_27.parent = this;
	this.instance_27.setTransform(507.8,48.5);
	this.instance_27.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(14).to({x:515},0).to({alpha:1},10).wait(201));

	// cookie-one
	this.instance_28 = new lib.cookieone_1();
	this.instance_28.parent = this;
	this.instance_28.setTransform(515,48.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(225));

	// tray
	this.instance_29 = new lib.leaderboardtray();
	this.instance_29.parent = this;
	this.instance_29.setTransform(317,69);

	this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(225));

	// candle-one
	this.instance_30 = new lib.leaaderboardcandles();
	this.instance_30.parent = this;
	this.instance_30.setTransform(184,75);

	this.timeline.addTween(cjs.Tween.get(this.instance_30).wait(225));

	// table
	this.instance_31 = new lib.leaderboardtable_1();
	this.instance_31.parent = this;
	this.instance_31.setTransform(364,47);
